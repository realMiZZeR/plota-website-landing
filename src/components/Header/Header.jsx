                    ...
                    <Link href={"/"}>
                        <svg width="73" height="24" viewBox="0 0 73 24" fill="black" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    ...
                                    <path d="M19.9994 0.5H16.7904V12C16.7904 16.1358 20.31 19.6807 24.2229 19.6385C24.2436 19.6385 24.285 19.6385 24.3057 19.6385V16.3679C24.285 16.3679 24.285 16.3679 24.2643 16.3679C22.0284 16.389 19.9994 14.3844 19.9994 12.0211V0.5Z" />
